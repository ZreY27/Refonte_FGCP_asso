...
<head>
    ...
    <script src="../script/carroussel.js" type="module"></script>
    <title>Accueil</title>
</head>
...
?>
        ...
        <div class="carrousel">
            <div class="slides">
                <img src="../img/accueil/image-carrousel1.jpg" alt="Image 1">
                <img src="../img/accueil/image-carrousel2.jpg" alt="Image 2">
                <img src="../img/accueil/image-carrousel3.jpg" alt="Image 3">
            </div>
...
En France, le taux de survie à <b>5 ans</b> après une greffe de cœur est d'environ <b>75%</b>,
        ...
        <div class="ruban">
            ...
            <img src="../img/accueil/ruban.png" alt="ruban vert">
